...
RSpec.describe 'users#show', type: :feature do
  describe 'users show' do
    before(:each) do
      ...
      @post3 = @user1.posts.create!(title: 'Pepe3 Post', text: 'Pepe3 text', comments_count: 0, likes_count: 0)
      @post4 = @user1.posts.create!(title: 'Pepe4 Post', text: 'Pepe4 text', comments_count: 0, likes_count: 0)
  ...
  describe 'click detail' do
    before(:each) do
      ...
      @post = @user.posts.create!(title: 'Pepe1 Post', text: 'Pepe1 text', comments_count: 0, likes_count: 0)
